...
function App() {
  return (
    ...
    >
      <nav className="flex flex-row justify-between gap-8 font-museomoderno font-bold text-sm items-center text-third sticky">
        <p>itsrenata2</p>
...
function Button({ children }) {
  return (
    <button className="bg-third px-6 py-2 rounded-xl text-main font-bold font-museomoderno">
      {children}
    </button>
  );
}
